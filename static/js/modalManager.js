...
const _LABELS = {
  ...
  'skills-lab-modal':  { label: 'Skills Lab', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M6 20V8l6-4 6 4v12"/><path d="M8.5 9.5h7"/><path d="M13 5l-2.5 7h3.5l-4 8 1-6H8l5-9z"/></svg>' },
...
const _AUTO_WIRE = {
  ...
  'skills-lab-modal':     { rail: 'rail-skills-lab', sidebar: 'tool-skills-lab-btn' },
